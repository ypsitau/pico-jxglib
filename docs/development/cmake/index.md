...
add_executable(your-project your-project.c)
...
[^about-interface]: For more details, see section "2.2. Every Library is an INTERFACE Library" in the [Raspberry Pi Pico-series C/C++ SDK](https://datasheets.raspberrypi.com/pico/raspberry-pi-pico-c-sdk.pdf). At first, it can be confusing if you think of a "library" as a physical file like `your-project.lib` or `your-project.a`.
