...
{% include "./sample/customcmd-arg-num/CMakeLists.txt" start="# mkdocs-start" end="# mkdocs-end" %}
```
...
Edit `customcmd-arg-num.cpp` as follows:

```cpp title="customcmd-arg-num.cpp" linenums="1"
{% include "./sample/customcmd-arg-num/customcmd-arg-num.cpp" %}
```
