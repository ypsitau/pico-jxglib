...
public:
	...
	public:
		interp_config& GetEntity() { return config_; }
	public:
		...
		Config& set_cross_input(bool cross_input) { ::interp_config_set_cross_input(&config_, cross_input); return *this; }
		Config& set_cross_result(bool cross_result) { ::interp_config_set_cross_result(&config_, cross_result); return *this; }
		Config& set_signed(bool _signed) { ::interp_config_set_signed(&config_, _signed); return *this; }
		Config& set_add_raw(bool add_raw) { ::interp_config_set_add_raw(&config_, add_raw); return *this; }
		Config& set_blend(bool blend) { ::interp_config_set_blend(&config_, blend); return *this; }
		Config& set_clamp(bool clamp) { ::interp_config_set_clamp(&config_, clamp); return *this; }
	...
	public:
		operator interp_hw_save_t() const { return saver_; }
	public:
		interp_hw_save_t& GetEntity() { return saver_; }
	};
private:
	interp_hw_t* interp_;
public:
...
public:
	...
	Interp& restore(Saver& saver) { ::interp_restore(interp_, &saver.GetEntity()); return *this; }
...
public:
	...
	Interp& set_config(uint lane, Config &config) { return set_config(lane, &config.GetEntity()); }
