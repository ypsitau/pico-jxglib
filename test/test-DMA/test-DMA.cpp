...
public:
	...
	public:
		ChannelConfig& set_read_increment(bool incr) { ::channel_config_set_read_increment(&config_, incr); return *this; }
		ChannelConfig& set_write_increment(bool incr) { ::channel_config_set_write_increment(&config_, incr); return *this; }
		ChannelConfig& set_dreq(uint dreq) { ::channel_config_set_dreq(&config_, dreq); return *this; }
		ChannelConfig& set_chain_to(uint chain_to) { ::channel_config_set_chain_to(&config_, chain_to); return *this; }
		ChannelConfig& set_transfer_data_size(enum dma_channel_transfer_size size) { ::channel_config_set_transfer_data_size(&config_, size); return *this; }
		ChannelConfig& set_ring(bool write, uint size_bits) { ::channel_config_set_ring(&config_, write, size_bits); return *this; }
		ChannelConfig& set_bswap(bool bswap) { ::channel_config_set_bswap(&config_, bswap); return *this; }
		ChannelConfig& set_irq_quiet(bool irq_quiet) { ::channel_config_set_irq_quiet(&config_, irq_quiet); return *this; }
		ChannelConfig& set_high_priority(bool high_priority) { ::channel_config_set_high_priority(&config_, high_priority); return *this; }
		ChannelConfig& set_enable(bool enable) { ::channel_config_set_enable(&config_, enable); return *this; }
		ChannelConfig& set_sniff_enable(bool sniff_enable) { ::channel_config_set_sniff_enable(&config_, sniff_enable); return *this; }
...
const DMA::Channel DMA::Channel0(0);
const DMA::Channel DMA::Channel1(1);
const DMA::Channel DMA::Channel2(2);
const DMA::Channel DMA::Channel3(3);
const DMA::Channel DMA::Channel4(4);
const DMA::Channel DMA::Channel5(5);
const DMA::Channel DMA::Channel6(6);
const DMA::Channel DMA::Channel7(7);
const DMA::Channel DMA::Channel8(8);
const DMA::Channel DMA::Channel9(9);
const DMA::Channel DMA::Channel10(10);
const DMA::Channel DMA::Channel11(11);
