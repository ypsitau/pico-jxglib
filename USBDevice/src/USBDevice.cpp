...
USBDevice::HID::HID(Controller& deviceController, uint32_t msecTick, const char* str, uint8_t protocol, const uint8_t* reportDesc, uint8_t bytesReportDesc,
...
USBDevice::Keyboard::Keyboard(Controller& deviceController, const char* str, uint8_t endpInterrupt, uint8_t pollingInterval) :
