...
public:
	...
	public:
		...
		virtual void DrawBitmap(int x, int y, const void* data, int width, int height, const Color& color, int scaleX = 1, int scaleY = 1) = 0;
	...
	public:
		...
		virtual void DrawBitmap(int x, int y, const void* data, int width, int height, const Color& color, int scaleX = 1, int scaleY = 1) override {}
...
public:
	...
	Drawable& DrawBitmap(int x, int y, const void* data, int width, int height, const Color& color, int scaleX = 1, int scaleY = 1) {
		GetDispatcher().DrawBitmap(x, y, data, width, height, color, scaleX, scaleY);
		return *this;
	}
	Drawable& DrawBitmap(const Point& pt, const void* data, int width, int height, const Color& color, int scaleX = 1, int scaleY = 1) {
		return DrawBitmap(pt.x, pt.y, data, width, height, color, scaleX, scaleY);
	}
